...
<body>
<div class="flex"> 
<div class="w-56 bg-indigo-100 h-screen shadow"> 
 <img src="https://smc.edu.np/wp-content/uploads/2023/11/smc-logo-circle.png" alt="" class="h-24 m-auto">
<ul class="mt-5">
...
<li class="my-2 text-center">
<a href="index.php" class="block p-2 text-lg font-bold  hover:bg-indigo-200 rounded text-indigo-600"> Logout  </a> </li>
 </ul>
</div>
